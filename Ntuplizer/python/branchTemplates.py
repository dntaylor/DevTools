...
metBranches = commonMet.clone(
    ...
    # shifts
    et_jetResUp           = cms.vstring('userFloat("shiftedPtJetResUp")','F'),
    et_jetResDown         = cms.vstring('userFloat("shiftedPtJetResDown")','F'),
    et_jetEnUp            = cms.vstring('userFloat("shiftedPtJetEnUp")','F'),
    et_jetEnDown          = cms.vstring('userFloat("shiftedPtJetEnDown")','F'),
    et_muonEnUp           = cms.vstring('userFloat("shiftedPtMuonEnUp")','F'),
    et_muonEnDown         = cms.vstring('userFloat("shiftedPtMuonEnDown")','F'),
    et_electronEnUp       = cms.vstring('userFloat("shiftedPtElectronEnUp")','F'),
    et_electronEnDown     = cms.vstring('userFloat("shiftedPtElectronEnDown")','F'),
    et_tauEnUp            = cms.vstring('userFloat("shiftedPtTauEnUp")','F'),
    et_tauEnDown          = cms.vstring('userFloat("shiftedPtTauEnDown")','F'),
    et_unclusteredEnUp    = cms.vstring('userFloat("shiftedPtUnclusteredEnUp")','F'),
    et_unclusteredEnDown  = cms.vstring('userFloat("shiftedPtUnclusteredEnDown")','F'),
    et_photonEnUp         = cms.vstring('userFloat("shiftedPtPhotonEnUp")','F'),
    et_photonEnDown       = cms.vstring('userFloat("shiftedPtPhotonEnDown")','F'),
    phi_jetResUp          = cms.vstring('userFloat("shiftedPhiJetResUp")','F'),
    phi_jetResDown        = cms.vstring('userFloat("shiftedPhiJetResDown")','F'),
    phi_jetEnUp           = cms.vstring('userFloat("shiftedPhiJetEnUp")','F'),
    phi_jetEnDown         = cms.vstring('userFloat("shiftedPhiJetEnDown")','F'),
    phi_muonEnUp          = cms.vstring('userFloat("shiftedPhiMuonEnUp")','F'),
    phi_muonEnDown        = cms.vstring('userFloat("shiftedPhiMuonEnDown")','F'),
    phi_electronEnUp      = cms.vstring('userFloat("shiftedPhiElectronEnUp")','F'),
    phi_electronEnDown    = cms.vstring('userFloat("shiftedPhiElectronEnDown")','F'),
    phi_tauEnUp           = cms.vstring('userFloat("shiftedPhiTauEnUp")','F'),
    phi_tauEnDown         = cms.vstring('userFloat("shiftedPhiTauEnDown")','F'),
    phi_unclusteredEnUp   = cms.vstring('userFloat("shiftedPhiUnclusteredEnUp")','F'),
    phi_unclusteredEnDown = cms.vstring('userFloat("shiftedPhiUnclusteredEnDown")','F'),
    phi_photonEnUp        = cms.vstring('userFloat("shiftedPhiPhotonEnUp")','F'),
    phi_photonEnDown      = cms.vstring('userFloat("shiftedPhiPhotonEnDown")','F'),
)
